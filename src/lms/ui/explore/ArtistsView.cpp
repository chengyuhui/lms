...
, _artistCollector {filters, _defaultMode}
{
	addFunction("tr", &Wt::WTemplate::Functions::tr);

	for (const auto& [mode, maxCount] : _maxItemsPerMode)
		_artistCollector.setMaxCount(mode, maxCount);
	...
	_artistCollector.setMode(_defaultMode);
	refreshView();
